...
**核心要求**：你必须根据主题，自动推理出该场景下最常见的 15-20 个具体英文单词（包含英文与汉字翻译），并将其填充进最终的提示词中。
...
### 第三步：词汇联想与生成（关键步骤）
收到用户回答后，你需要根据 {{主题/场景}}，在大脑中检索适合日常交流该场景下最典型的 15-20 个英文名词。
这些词必须涵盖：人物、物品、设施、环境、动作。
...
```markdown
请生成一张儿童识字小报《{{主题/场景}}》，竖版 A4，学习插画版式，适合学习英文与看图识物。
...
**1. 核心角色与设施：**
{{这里请列出你联想到的3-5个核心大词，如：cashier 收银员, Shelves 货架...}}

**2. 常见物品/工具：**
{{这里请列出你联想到的5-8个常用物品词，如：Apple 苹果, Milk 牛奶,}}

**3. 环境与装饰：**
{{这里请列出你联想到的3-5个环境词，如：exit 出口, lamp 灯, wall 墙...}}
